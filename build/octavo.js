...
(function() {
  ...
  on_keydown = function(e) {
    ...
    if (octavo.editing) {
      ...
      if ((_ref = e.which) !== 16 && _ref !== 17 && _ref !== 18 && _ref !== 91) {
  ...
  markdown_to_html = function(position, pattern, tag, guard) {
    var code, contents, node, range, string, text, _ref, _ref1, _ref2;
    node = (_ref = position.range) != null ? _ref.startContainer : void 0;
    if (node && (node.nodeType === 3) && node.textContent) {
      ...
      if (text) {
        ...
        if ((_ref1 = code[0].nextSibling) != null ? _ref1.nextSibling : void 0) {
          octavo.selectStart((_ref2 = code[0].nextSibling) != null ? _ref2.nextSibling : void 0);
        } else {
  ...
  on_keyup = function(e) {
    var changed, position, pressed, _ref;
    pressed = key(e);
    if (octavo.editing) {
      if (e.which === 17) {
        return;
  ...
  get_position = function() {
    var block, element, phrase, position, range, selection, tags, tree, _ref;
    position = {};
    ...
    if (range) {
      ...
      _ref = get_tree(range.startContainer), element = _ref[0], phrase = _ref[1], block = _ref[2], tree = _ref[3], tags = _ref[4];
  ...
  update_status = function(position) {
    var a, arrow, build, i, length, menu, node, offset, q, start, status, tag, _i, _ref, _ref1;
    if (!position) {
      return;
    }
    if (!position.tags) {
    ...
    if (!((_ref = status[0]) != null ? (_ref1 = _ref.childNodes) != null ? _ref1.length : void 0 : void 0)) {
  ...
  create_command_menu = function(position, node) {
    ...
    do_command = function() {
      var command, status, _ref;
      if (octavo._current) {
        command = octavo.commands[octavo._current[0]][octavo._current[1]];
        if ((_ref = octavo._current[0]) === "Insert" || _ref === "Selection") {
